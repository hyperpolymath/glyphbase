...
*Build Date:* 2026-02-06 *Vite Version:* 6.4.1 *Build Time:* 2.02
seconds
...
[width="100%",cols="20%,23%,57%",options="header",]
|===
|Application |Bundle Size (gzipped) |Features
|*Glyphbase* |*65.66 kB* |Grid, Calendar, Kanban, Gallery, Form,
Collaboration
...
The ReScript + Vite stack delivers outstanding results. The application
is ready for deployment with no performance concerns.
