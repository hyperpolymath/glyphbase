...
*Carve your data in stone* - Multiple installation options for every use
case.
...
*Prerequisites:* - https://gleam.run[Gleam] 1.7+ -
https://deno.land[Deno] 2.0+ -
...
*Pros:* Easiest setup, works everywhere, no dependencies *Cons:* Less
...
*Pros:* Rootless, more secure, compatible with Docker *Cons:* Slightly
different commands
...
*Pros:* Full control, latest features, contribution-ready *Cons:*
...
*Ports:* - UI (dev): `+http://localhost:3000+` - Server:
`+http://localhost:4000+` - API: `+http://localhost:4000/api+`

==== 5. Self-Hosting on VPS

*Pros:* Full control, custom domain, professional deployment *Cons:*
...
*Pros:* Enterprise-scale, auto-scaling, high availability *Cons:*
Complex setup
...
|`+SECRET_KEY+` |_(required)_ |Session encryption key (production)
...
[arabic]
. *Quick Start Guide:* See link:./QUICKSTART.md[QUICKSTART.md]
. *User Guide:* See link:./docs/USER-GUIDE.adoc[docs/USER-GUIDE.adoc]
. *API Documentation:* https://docs.lithoglyph.org/api
. *Contributing:* See link:.github/CONTRIBUTING.md[CONTRIBUTING.md]
